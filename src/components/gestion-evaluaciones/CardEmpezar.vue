<template>
    <div>
        <Card style=" overflow: hidden " class="p-2 w-full">
            ...
            <template #content>
                <section class="flex gap-1 ">
                    ...
                    <i class="pi pi-pen-to-square text-surface-800" style="font-size: 5rem"></i>
                </section>
            </template>
            <template #footer>
                <div class="flex flex-row-reverse gap-4 mt-1">
                    <Button as="router-link" label="Empezar"  to="/Catalogo" severity=""  class="w-fit bg-primary-500" icon="pi pi-chevron-right" icon-pos="right"/>
                </div>
            </template>
        </Card>
    </div>

<template>
    <div class="flex flex-col gap-2 h-screen w-full">
        <div class="flex justify-end flex-row-reverse w-full h-full">
            <section class="flex flex-col gap-2 mt-2 w-full">
                <Tabs  value="/software" class="w-fit">

                    <TabList class="border border-surface-800 rounded-md px-1 bg-surface-900" >
                        <Tab value="/software"  @click="navigateTo('software')">Resultados</Tab>
                        <Tab value="/evaluaciones" @click="navigateTo('evaluaciones')">Comentarios</Tab>
                    </TabList>
                </Tabs>
...
import CardPromedioFinal from '../components/gestion-evaluaciones/CardPromedioFinal.vue';
import CardPromedioTotal from '../components/gestion-evaluaciones/CardPromedioTotal.vue';
